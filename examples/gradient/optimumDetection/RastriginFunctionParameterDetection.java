...
public class RastriginFunctionParameterDetection {

	private RastriginFunctionParameterDetection() {}
	...
	public static void main(String[] args) {
		...
		IStartSolutionGenerator<DoubleArraySolution> startSolutionGenerator =
				new RandomStartSolutionGenerator(variableCount, standardSearchMin, standardSearchMax);
		...
		double momentDecreaseFactor = 0.95;
