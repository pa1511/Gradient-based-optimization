...
public class BealesFunctionParameterDetection {

	private BealesFunctionParameterDetection() {}
	...
	public static void main(String[] args) {
		...
		double momentDecreaseFactor = 0.5;
//		int dimensionRepeatFactor = 3;
		double learningRate = 0.0002;
		IGradientBasedUpdater updater = 
				//new AdjustingGradientUpdater(function, variableCount);
				new MomentGradientUpdater(learningRate, momentDecreaseFactor, variableCount );
				//new PerDimensionGradientUpdater(learningRate, dimensionRepeatFactor);
				//new SimpleGradientUpdater(learningRate);
